						...
						<div class="meta-box-sortables">
							<div class="postbox">
								...
								<div class="inside">
									...
									<a class="button button-primary button-orange" href="<?php echo esc_url( WTPSW_PLUGIN_LINK ); ?>" target="_blank"><?php esc_html_e( 'Grab Now', 'wtpsw' ); ?></a>
								</div><!-- .inside -->
							</div><!-- #general -->
						...
						<div class="meta-box-sortables">
							<div class="postbox">
								...
								<div class="inside">
									...
									<a class="button button-primary wpos-button-full button-orange" href="<?php echo esc_url(WTPSW_PLUGIN_LINK); ?>" target="_blank"><?php esc_html_e( 'Grab Now', 'wtpsw' ); ?></a>
								</div><!-- .inside -->
							</div><!-- #general -->
