...
if ( !class_exists( 'Newslist_Customizer' ) ) {
	class Newslist_Customizer extends Newslist_Helper {
		 ...
		 * @package Newslist WordPress Theme
		 */
		public static function validate_argument( $args ) {
...
<?php
		 ...
		 * @package Newslist WordPress Theme
		 */
		public static function get_control_arg( $section, $field, $prefix_on_section = true ) {
			$args = array();
		 ...
		 * @package Newslist WordPress Theme
		 */
		public static function get_section_arg( $panel_id = false, $section ) {
			$args = array(
