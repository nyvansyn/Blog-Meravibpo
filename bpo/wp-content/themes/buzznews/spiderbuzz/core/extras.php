		...
		?>
			<div class="sb-mobile-menu">
				<nav class="navbar navbar-expand-lg navbar-light bg-light box-header-nav">
					...
					<?php do_action('buzznews_menu_toggle'); ?>
			...
			<div class="buzznews-newsfeed-outer-wrapper">
				<div class="container">
					<div class="buzznews-newsfeed-inner-wrapper">
						<div class="row">
							<?php 
								if( $buzznews_slider_tranding_enable == true ):
									/**
										...
										<div class="item">
											<?php 
												...
												if( has_post_thumbnail($post_item->ID) ){
													echo get_the_post_thumbnail($post_item->ID, 'buzznews-main-slider'); 
												}else{
													echo sprintf( '<img src="%s" alt="%s">',BUZZNEWS_THEME_IMG.'countdown.png',get_the_title() );
												}
											?>
											...
											<div class="middle-details">
												...
												<div class="image">
													<?php 
														echo wp_kses_post( buzznews_meta_authorlink( $post_item->ID ) );
														get_buzznews_post_timedate( $post_item->ID ); 
													?>
												</div>
											</div>
										</div>
													...
													<div class="row">
														...
														<?php endif; ?>
																<div class="image-details">
																	...
																	<div class="image">
																		<?php 
																			echo wp_kses_post( buzznews_meta_authorlink(get_the_ID()) );
																			get_buzznews_post_timedate(); 
																		?>
																	</div>
																</div>	
															</div>
										...
										<div class="middle-bottom-wrapper-image">
											<?php 
												if( has_post_thumbnail() ){
													...
													echo sprintf( '<img src="%s" alt="%s">',BUZZNEWS_THEME_IMG.'grid-thumbnail.jpg',get_the_title() );
												}
											?>
										</div>
										<?php buzznews_post_format_icon();//#post format  ?>
					...
					<div class="buzznews-fullslider-inner-wrapper">
						<div  class="buzzmag-grid-slider" >
							<div class="buzznews-fullslider-slider">
								...
								<?php
									if( $categoryid ) :
										foreach( $categoryid as $postcategory ): 
									?>
										<div class="">
