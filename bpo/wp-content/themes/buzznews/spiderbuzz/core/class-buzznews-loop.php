					...
					<div class="buzznews-trendingnews-outer-wrapper">
						<div class="buzznews-trendingnews-inner-wrapper">
							<div class="buzznews-trendingnews-left">
								<?php 
									if ( have_posts() ) :
										do_action( 'buzznews_template_parts_content_top' ); 
										while ( have_posts() ) :
											the_post();
										...
										if( get_theme_mod('buzznews_infinite_scrolling') ){
											echo '<div class="buzznews-infinite-scrolling-post"></div>';
										}
									do_action( 'buzznews_template_parts_content_bottom' );
								else :
									do_action( 'buzznews_template_parts_content_none' );
								endif; 
							?>
							</div>
						</div>
									...
									<div class="col-lg-4 col-md-4 buzznews-matchheight-article">
										<div class="middle-bottom-wrapper">
											<?php
												...
												echo sprintf( '<div class="middle-bottom-wrapper-image">' );
