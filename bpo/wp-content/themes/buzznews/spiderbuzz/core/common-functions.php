		...
		if ( apply_filters( 'buzznews_the_title_enabled', true ) ) {
			...
			if ( is_author() ) { ?>
				...
				if( $title ){
					echo sprintf( 
						'<section class="buzznews-archive-description">
							<h1 class="page-title buzznews-archive-title">%s</h1>
						</section>',
						esc_html( $title ) 
					);
				}
				...
				sprintf( '<section class="buzznews-archive-description">' );
					the_archive_title( '<h1 class="page-title buzznews-archive-title">', '</h1>' );
