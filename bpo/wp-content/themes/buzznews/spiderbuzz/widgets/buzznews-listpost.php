							...
							<div class="buzznews-ajax-buttom center-bttn">
								<div class="buzznews-trendingnews-right">
									...
									<div class="buzznews-postlist-arrow buzznews-fullpostlist">
										<span class="load-more" catId="<?php echo esc_attr( $home_blog_category_id ); ?>" postCount="<?php echo esc_attr( $number_posts ); ?>" postPaginate="2"  postLastPaginate="<?php echo esc_attr( $last_page_count ); ?>"  postDisplayStyle="fullpostlist" ><a href="#"><?php echo esc_html__('Load More','buzznews'); ?></a></span>
									</div>
								</div>
							</div>
						</div>
