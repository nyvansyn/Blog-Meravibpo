...
function buzznews_frontpage_category_post( $wp_customize ) {
    ...
    $wp_customize->add_section( 'buzznews_category_post', array(
        'title'    => esc_html__( 'Category Post List', 'buzznews' ),
        'priority' => 12,
    ...
    $wp_customize->add_control(
		new BuzzNews_Toggle_Control( 
			...
			array(
				...
				'label'		  => esc_html__( 'Enable Category Post List', 'buzznews' ),
                'priority'    => 1
			)
		)
	);
	...
	$wp_customize->add_control(
		new Buzznews_MultiCheck_Control(
			...
			array(
				'section'     => 'buzznews_category_post',
				'label'       => esc_html__( 'Select Post Category', 'buzznews' ),
    ...
    $wp_customize->add_control(
		...
		array(
			'section'	  => 'buzznews_category_post',
			'label'		  => esc_html__( 'Number of Post in Each Category', 'buzznews' ),
            'type'        => 'number',
            'priority'      => 7,
		)		
    );
