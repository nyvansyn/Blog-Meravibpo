...
function buzznews_frontpage_slider( $wp_customize ) {
    ...
    $wp_customize->add_section( 'buzznews_blog_section', array(
        'title'    => esc_html__( 'Front Page Slider', 'buzznews' ),
        'priority' => 12,
    ...
    $wp_customize->add_control(
		new BuzzNews_Toggle_Control( 
			...
			array(
                ...
                'description' => esc_html__( 'Enable/Disable Slider Post Exclusive.', 'buzznews' ),
                'priority'    => 1
			)
		)
    );
    ...
    $wp_customize->add_control(
		new BuzzNews_Toggle_Control( 
			...
			array(
				'section'	  => 'buzznews_blog_section',
				'label'		  => esc_html__( 'Enable Grid', 'buzznews' ),
                'description' => esc_html__( 'Enable/Disable Slider Below Grid.', 'buzznews' ),
                'priority'    => 1
			)
		)
    );
    ...
    $wp_customize->add_control(
		new BuzzNews_Toggle_Control( 
			...
			array(
				'section'	  => 'buzznews_blog_section',
				'label'		  => esc_html__( 'Enable Trending News', 'buzznews' ),
                'priority'    => 4
			)
		)
    );
    ...
    $wp_customize->add_control(
		...
		array(
			'section'	  => 'buzznews_blog_section',
            'label'		  => esc_html__( 'Trending News Title', 'buzznews' ),
            'type'        => 'text',
            'priority'    => 5,
		)		
    );
    ...
    $wp_customize->add_control( 
        'buzznews_tranding_news_cat_id', 
        array(
			'label'         => esc_html__( 'Trending News Category', 'buzznews' ),
            'section'       => 'buzznews_blog_section',
            'type'          => 'select',
            'choices'       => buzznews_get_post_categories( ),
            'priority'      => 6,
    ...
    $wp_customize->add_control(
		...
		array(
			'section'	  => 'buzznews_blog_section',
			'label'		  => esc_html__( 'Trending News - Number of Post', 'buzznews' ),
            'type'        => 'number',
            'priority'      => 7,
		)		
    );
    ...
    $wp_customize->add_control(
		...
		array(
			'section'	  => 'buzznews_blog_section',
			'label'		  => esc_html__( 'Slider Right - Number of Post', 'buzznews' ),
            'type'        => 'number',
            'priority'      => 10,
		)		
    );
